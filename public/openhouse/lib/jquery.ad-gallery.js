...
(function($) {
    ...
    AdGallery.prototype = {
        ...
        setupElements: function() {
            ...
            this.loader = $('<img class="ad-loader" src="../assets/lib/' + this.settings.loader_image + '">');
        ...
        addImage: function(thumb_url, image_url, image_id, title, description) {
            ...
            var li = $('<li><a href="../assets/lib/' + image_url + '" id="' + image_id + '">' +
            '<img src="../assets/lib/' + thumb_url + '" title="' + title + '" alt="' + description + '">' +
            '</a></li>');
            var context = this;
        ...
        _showWhenLoaded: function(index, callback) {
            if (this.images[index]) {
                ...
                if (image.link) {
                    var link = $('<a href="../assets/lib/' + image.link + '" target="_blank"></a>');
                    link.append(img);
